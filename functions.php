...
function check_login($con) //De functie verwacht een parameter genaamd $con die een MySQLi-verbinding representeert
{
    ...
    if(isset($_SESSION['user_id'])) //Er wordt een check uitgevoerd om te kijken of de $_SESSION-variabele 'user_id' is gezet
    {

        $id = $_SESSION['user_id']; //Als de $_SESSION['user_id'] is gezet, wordt de variabele $id gezet op de waarde van $_SESSION['user_id']
